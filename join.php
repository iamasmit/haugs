...
@media screen and (max-width: 500px) {
  ...
  <body>
    <section class="container">
      <header>Community Registration Form</header>
...
if(isset($_POST['submit'])){
    ...
    && !empty($_POST['address'])  && !empty($_POST['country']) && !empty($_POST['city']) 
    && !empty($_POST['region']) && !empty($_POST['postal']) && !empty($_POST['file_img'])){
       $fname = $_POST['fname']; 
       $email = $_POST['email']; 
       $phone = $_POST['phone']; 
       ...
       $folder = "upload/".$file_img;
       move_uploaded_file($tempname,$folder);

    
       $query =" insert into form (fname,email,phone,date,gender,address,country,city,region,postal,file_img) 
       values('$fname','$email','$phone','$date','$gender','$address','$country','$city','$region','$postal', '$file_img')";
